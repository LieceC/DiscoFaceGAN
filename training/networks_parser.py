...
def fpn(c1,c2,c3,c4,data_format = 'channels_first'):
	...
	with tf.compat.v1.variable_scope('convlast'):
...
def MaskNet(x,is_training = False,data_format = 'channels_first'):
	with tf.compat.v1.variable_scope('neck'):
...
def FaceParser(inputs, data_format = 'channels_first',is_training = False):
	with tf.compat.v1.variable_scope('resnet',reuse = tf.compat.v1.AUTO_REUSE):
		with tf.compat.v1.variable_scope('block0'):
	...
	with tf.compat.v1.variable_scope('fpn',reuse = tf.compat.v1.AUTO_REUSE):

		x = fpn(c1,c2,c3,c4)

	with tf.compat.v1.variable_scope('MaskNet',reuse = tf.compat.v1.AUTO_REUSE):
		x = MaskNet(x)
...
def Parsing(inputs,lm):
	...
	with tf.compat.v1.variable_scope('FaceParser'):
